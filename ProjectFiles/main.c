...
// #include <blinkExternalLED.h>

// static QueueSetHandle_t xQueue1 = NULL;

// void blink(){

//     while(1){
//         turnOnExternalLED(BUTTON_PIN_18);
//         printf("LED ON");
//         vTaskDelay(100);
//         turnOffExternalLED(BUTTON_PIN_18);
//         printf("LED OFF");
//         vTaskDelay(100);
//     }
// }
...
//     stdio_init_all();
//     stdio_init_all();
//     init_ExternalLed(BUTTON_PIN_18);
//     init_Button(BUTTON_PIN_15);
//     init_temperatureADC();

//     // xQueue1 = xQueueCreate(1, sizeof(unit));

//     xTaskCreate(blink, "LED task", 256, NULL, 1, NULL);
